...
namespace sistemaClientes
{
    public partial class modificar : Form
    {
        ...
        private void Modificar_Load(object sender, EventArgs e)
        {
            ...
            cargardatos();
            txtci.DataBindings.Add("Text", bs, "EDIFICIO");
            txtnombres.DataBindings.Add("Text", bs, "NOMBRE");
            txtapellidop.DataBindings.Add("Text", bs, "APELLIDO MATERNO");
            txtapellidom.DataBindings.Add("Text", bs, "CARRERA");
            txtcel.DataBindings.Add("Text", bs, "AULA");
